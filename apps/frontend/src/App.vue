...
const m = defineMessages({
	...
	fieldBadgeMetric: { id: 'field.badge-metric', defaultMessage: 'Badge Metric' },
	fieldProjectType: { id: 'field.project-type', defaultMessage: 'Project Type' },
	...
	optionShowProjects: { id: 'option.show-projects', defaultMessage: 'Show Projects' },
	optionMaxProjects: { id: 'option.max-projects', defaultMessage: 'Max Projects' },
	optionShowVersions: { id: 'option.show-versions', defaultMessage: 'Show Versions' },
	optionShowFiles: { id: 'option.show-files', defaultMessage: 'Show Files' },
	optionMaxVersions: { id: 'option.max-versions', defaultMessage: 'Max Versions' },
	optionMaxFiles: { id: 'option.max-files', defaultMessage: 'Max Files' },
	optionRelativeTime: { id: 'option.relative-time', defaultMessage: 'Relative Time' },
	optionSparklines: { id: 'option.sparklines', defaultMessage: 'Sparkline Graphs' },
	optionDownloadBars: { id: 'option.download-bars', defaultMessage: 'Download Bars' },
	optionShowIcon: { id: 'option.show-icon', defaultMessage: 'Show Platform Icon' },
	optionShowBorder: { id: 'option.show-border', defaultMessage: 'Show Border' },
	optionAnimations: { id: 'option.animations', defaultMessage: 'Animations' },
	optionAccentColor: { id: 'option.accent-color', defaultMessage: 'Accent Color' },
	optionBgColor: { id: 'option.bg-color', defaultMessage: 'Background Color' },

	valueLabelUserCurseforge: { id: 'value-label.user.curseforge', defaultMessage: 'User ID' },
	valueLabelUserDefault: { id: 'value-label.user.default', defaultMessage: 'Username' },
	valueLabelProjectCurseforge: {
		id: 'value-label.project.curseforge',
		defaultMessage: 'Project ID',
	},
	valueLabelProjectSpigot: { id: 'value-label.project.spigot', defaultMessage: 'Project ID' },
	valueLabelProjectDefault: { id: 'value-label.project.default', defaultMessage: 'Project Slug' },
	valueLabelOrganization: { id: 'value-label.organization', defaultMessage: 'Organization Slug' },
	valueLabelCollection: { id: 'value-label.collection', defaultMessage: 'Collection ID' },
	valueLabelAuthor: { id: 'value-label.author', defaultMessage: 'Author ID' },
	valueLabelResource: { id: 'value-label.resource', defaultMessage: 'Resource ID' },
	valueLabelServer: { id: 'value-label.server', defaultMessage: 'Server Slug' },
	valueLabelDefault: { id: 'value-label.default', defaultMessage: 'Value' },
	...
	projectTypeAll: { id: 'project-type.all', defaultMessage: 'All Types' },
	projectTypeMod: { id: 'project-type.mod', defaultMessage: 'Mods' },
	projectTypeModpack: { id: 'project-type.modpack', defaultMessage: 'Modpacks' },
	projectTypeResourcepack: { id: 'project-type.resourcepack', defaultMessage: 'Resource Packs' },
	projectTypeShader: { id: 'project-type.shader', defaultMessage: 'Shaders' },
	projectTypeDatapack: { id: 'project-type.datapack', defaultMessage: 'Data Packs' },
	projectTypePlugin: { id: 'project-type.plugin', defaultMessage: 'Plugins' },
	projectTypeTexturePack: { id: 'project-type.texture-pack', defaultMessage: 'Texture Packs' },
	projectTypeBukkitPlugin: { id: 'project-type.bukkit-plugin', defaultMessage: 'Bukkit Plugins' },

	hintTransparentBg: {
		id: 'hint.transparent-bg',
		defaultMessage:
	...
	errorApiDown: { id: 'error.api-down', defaultMessage: 'The {platform} API is currently down.' },

	previewPlaceholder: { id: 'preview.placeholder', defaultMessage: 'Your embed will appear here' },
	previewImageAlt: { id: 'preview.image-alt', defaultMessage: 'Preview' },

	outputMarkdownPlaceholder: {
		id: 'output.markdown-placeholder',
		defaultMessage: 'Your markdown code will appear here',
	},
	outputHtmlPlaceholder: {
		id: 'output.html-placeholder',
		defaultMessage: 'Your HTML code will appear here',
	},
	outputUrlPlaceholder: {
		id: 'output.url-placeholder',
		defaultMessage: 'Your URL will appear here',
	},

	actionCopyMarkdown: { id: 'action.copy-markdown', defaultMessage: 'Copy Markdown' },
	actionCopyHtml: { id: 'action.copy-html', defaultMessage: 'Copy HTML' },
	actionCopyUrl: { id: 'action.copy-url', defaultMessage: 'Copy URL' },
